...
SDName: boss_maximus
SD%Complete: 99
SDComment: When Maximus dies the emote that he killed someone and that he dies trigger at the same moment, while none is actually killed.
SDCategory: Custom script, optimal for Ragefire Chasm
EndScriptData */
...
enum Spells
{
	...
	SPELL_FABULOUS_FLAMES              = 95423,
    SPELL_FIREBALL_BARRAGE             = 86155,
	//Phase three 
	SPELL_SPIRITUAL_IMMUNITY           = 95332,
