...
enum DruidSpells
{
	GDRUID_T16_AURA_2P						= 144879,
	GDRUID_T16_SPELL_2P						= 132402,
	GDRUID_T16_AURA_4P						= 144887,
	GDRUID_T16_SPELL_4P						= 144888,
    DRUID_INCREASED_MOONFIRE_DURATION       = 38414,
	DRUID_T162PBALANCE_AURA					= 144767,
	DRUID_T162PBALANCE_SPELL				= 144770,
	...
	DRUID_T164PFERAL_AURA					= 144841,
	DRUID_T164PFERAL_SPELL					= 146874,
	DRUID_SPELL_ADD_COMBO_POINT				= 139546
};
...
class spell_item_druid_tank_t16_2p : public SpellScriptLoader
{
public:
	spell_item_druid_tank_t16_2p() : SpellScriptLoader("spell_item_druid_tank_t16_2p") { }

	class spell_item_druid_tank_t16_2p_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_item_druid_tank_t16_2p_SpellScript);

		void HandleOnCast()
		{
			if (Unit* l_Caster = GetCaster())
					if (l_Caster->HasAura(GDRUID_T16_AURA_2P))
						l_Caster->CastSpell(l_Caster, GDRUID_T16_SPELL_2P, true);
		}

		void Register()
		{
			OnCast += SpellCastFn(spell_item_druid_tank_t16_2p_SpellScript::HandleOnCast);
		}
	};

	SpellScript* GetSpellScript() const
	{
		return new spell_item_druid_tank_t16_2p_SpellScript();
	}
};
	...
	class spell_item_druid_t16_guardian_4p_SpellScript : public SpellScript
	{
		...
		void HandleAfterCast()
		{
			if (Player* _player = GetCaster()->ToPlayer())
			{
				...
				{
					int32 amount = _player->GetTotalAttackPowerValue(BASE_ATTACK) * 0.0675f;
...
class spell_item_druid_t16_guardian_2p : public SpellScriptLoader
{
public:
	spell_item_druid_t16_guardian_2p() : SpellScriptLoader("spell_item_druid_t16_guardian_2p") { }

	class spell_item_druid_t16_guardian_2p_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_item_druid_t16_guardian_2p_SpellScript);

		void HandleAfterCast()
		{
			if (Player* _player = GetCaster()->ToPlayer())
			{
				if (_player->HasAura(144879))
				{
					int32 amount = _player->GetTotalAttackPowerValue(BASE_ATTACK) * 0.0675f;
					_player->CastCustomSpell(132402, SPELLVALUE_BASE_POINT0, amount, _player, true);
				}
			}
		}
		...
		void Register()
		{
			AfterCast += SpellCastFn(spell_item_druid_t16_guardian_2p_SpellScript::HandleAfterCast);
		}
	};

	SpellScript* GetSpellScript() const
	{
		return new spell_item_druid_t16_guardian_2p_SpellScript();
	}
};

//Bonus 2p Balance
class spell_item_druid_t16_balance_2p : public SpellScriptLoader
{
public:
	spell_item_druid_t16_balance_2p() : SpellScriptLoader("spell_item_druid_t16_balance_2p") { }

	class spell_item_druid_t16_balance_2p_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_item_druid_t16_balance_2p_SpellScript);

		void HandleOnHit()
		{
			if (Player* _player = GetCaster()->ToPlayer())
				if (Unit* target = GetHitUnit())
					if (_player->HasAura(DRUID_T162PBALANCE_AURA))
						_player->CastSpell(target, DRUID_T162PBALANCE_SPELL, true);
		...
		void Register()
		{
			OnHit += SpellHitFn(spell_item_druid_t16_balance_2p_SpellScript::HandleOnHit);
		}
	};

	SpellScript* GetSpellScript() const
	{
		return new spell_item_druid_t16_balance_2p_SpellScript();
	}
};
// T16 TIGERS FURY
class spell_item_druid_t16_feral_4p_buff : public SpellScriptLoader
{
public:
	spell_item_druid_t16_feral_4p_buff() : SpellScriptLoader("spell_item_druid_t16_feral_4p_buff") { }

	class spell_item_druid_t16_feral_4p_buff_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_item_druid_t16_feral_4p_buff_SpellScript);

		void HandleOnCast()
		{
			if (Unit* caster = GetCaster())

				if (caster->HasAura(DRUID_T164PFERAL_AURA))

					caster->CastSpell(caster, DRUID_T164PFERAL_SPELL, true);
		...
		void Register()
		{
			OnCast += SpellCastFn(spell_item_druid_t16_feral_4p_buff_SpellScript::HandleOnCast);
		}
	};

	SpellScript* GetSpellScript() const
	{
		return new spell_item_druid_t16_feral_4p_buff_SpellScript();
	}
};



class spell_item_druid_t16_feral_4p_combo1 : public SpellScriptLoader
{
public:
	spell_item_druid_t16_feral_4p_combo1() : SpellScriptLoader("spell_item_druid_t16_feral_4p_combo1") { }

	class spell_item_druid_t16_feral_4p_combo1_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_item_druid_t16_feral_4p_combo1_SpellScript);

		void HandleOnHit()
		{
			if (Player* _player = GetCaster()->ToPlayer())
				if (Unit* target = GetHitUnit())
					if (_player->HasAura(DRUID_T164PFERAL_SPELL))
						_player->CastSpell(target, DRUID_SPELL_ADD_COMBO_POINT, true);
		...
		void Register()
		{
			OnHit += SpellHitFn(spell_item_druid_t16_feral_4p_combo1_SpellScript::HandleOnHit);
		}
	};

	SpellScript* GetSpellScript() const
	{
		return new spell_item_druid_t16_feral_4p_combo1_SpellScript();
	}
};

class spell_item_druid_t16_feral_4p_combo2 : public SpellScriptLoader
{
public:
	spell_item_druid_t16_feral_4p_combo2() : SpellScriptLoader("spell_item_druid_t16_feral_4p_combo2") { }

	class spell_item_druid_t16_feral_4p_combo2_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_item_druid_t16_feral_4p_combo2_SpellScript);
		...
		void Register()
		{
			OnHit += SpellHitFn(spell_item_druid_t16_feral_4p_combo2_SpellScript::HandleOnHit);
		}
	};

	SpellScript* GetSpellScript() const
	{
		return new spell_item_druid_t16_feral_4p_combo2_SpellScript();
	}
};

class spell_item_druid_t16_feral_4p_combo3 : public SpellScriptLoader
{
public:
	spell_item_druid_t16_feral_4p_combo3() : SpellScriptLoader("spell_item_druid_t16_feral_4p_combo3") { }

	class spell_item_druid_t16_feral_4p_combo3_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_item_druid_t16_feral_4p_combo3_SpellScript);
		...
		void Register()
		{
			OnHit += SpellHitFn(spell_item_druid_t16_feral_4p_combo3_SpellScript::HandleOnHit);
		}
	};

	SpellScript* GetSpellScript() const
	{
		return new spell_item_druid_t16_feral_4p_combo3_SpellScript();
	}
};

void AddSC_druid_spell_scripts()
{
	new spell_item_druid_t16_feral_4p_combo1();
	new spell_item_druid_t16_feral_4p_combo2();
	new spell_item_druid_t16_feral_4p_combo3();
	new spell_item_druid_t16_feral_4p_buff();
	new spell_item_druid_t16_guardian_4p();
	new spell_item_druid_tank_t16_2p();
	...
	new spell_item_druid_t16_balance_2p();
