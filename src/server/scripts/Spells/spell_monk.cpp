...
class spell_novo_esferas1 : public SpellScriptLoader
{
public:
	spell_novo_esferas1() : SpellScriptLoader("spell_novo_esferas1") { }

	class spell_novo_esferas1_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_novo_esferas1_SpellScript);
		...
		void HandleOnCast()
		{
			if (Unit* caster = GetCaster())
				...
				if (caster->HasAura(21359))
					...
					caster->CastSpell(caster, 123730, true);
		...
		void Register()
		{
			OnCast += SpellCastFn(spell_novo_esferas1_SpellScript::HandleOnCast);
		}
	};

	SpellScript* GetSpellScript() const
	{
		return new spell_novo_esferas1_SpellScript();
	}
};

class spell_novo_esferas2 : public SpellScriptLoader
{
public:
	spell_novo_esferas2() : SpellScriptLoader("spell_novo_esferas2") { }

	class spell_novo_esferas2_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_novo_esferas2_SpellScript);
		...
		void HandleOnCast()
		{
			if (Unit* caster = GetCaster())
				...
				if (caster->HasAura(21359))
					...
					caster->CastSpell(caster, 123731, true);
		...
		void Register()
		{
			OnCast += SpellCastFn(spell_novo_esferas2_SpellScript::HandleOnCast);
		}
	};

	SpellScript* GetSpellScript() const
	{
		return new spell_novo_esferas2_SpellScript();
	}
};

class spell_novo_cinzas : public SpellScriptLoader
{
public:
	spell_novo_cinzas() : SpellScriptLoader("spell_novo_cinzas") { }

	class spell_novo_cinzas_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_novo_cinzas_SpellScript);
		...
		void HandleOnCast()
		{
			if (Unit* caster = GetCaster())
				...
				if (caster->HasAura(21359))
					...
					caster->CastSpell(caster, 142872, true);
		...
		void Register()
		{
			OnCast += SpellCastFn(spell_novo_cinzas_SpellScript::HandleOnCast);
		}
	};

	SpellScript* GetSpellScript() const
	{
		return new spell_novo_cinzas_SpellScript();
	}
};

class spell_memoriamuscular : public SpellScriptLoader
{
public:
	spell_memoriamuscular() : SpellScriptLoader("spell_memoriamuscular") { }

	class spell_memoriamuscular_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_memoriamuscular_SpellScript);

		void HandleOnCast()
		{
			if (Unit* caster = GetCaster())

				if (caster->HasAura(SPELL_MONK_MUSCLE_MEMORY))

					caster->CastSpell(caster, SPELL_MONK_MUSCLE_MEMORY_EFFECT, true);
		...
		void Register()
		{
			OnCast += SpellCastFn(spell_memoriamuscular_SpellScript::HandleOnCast);
		}
	};

	SpellScript* GetSpellScript() const
	{
		return new spell_memoriamuscular_SpellScript();
	}
};

void AddSC_monk_spell_scripts()
{
	new spell_memoriamuscular();
	new spell_novo_esferas1();
	new spell_novo_esferas2();
	new spell_novo_cinzas();
