...

{
	...
	RETPALA_SEALOFTRUTH_AURA					 = 31801,
	RETPALA_SEALOFTRUTH_SPELL					 = 31803,
	RETPALA_T16_SPELL_4P						 = 144595,
	RETPALA_T16_AURA_4P							 = 144593,
...
class spell_item_paladin_t16_4p : public SpellScriptLoader
{
public:
	spell_item_paladin_t16_4p() : SpellScriptLoader("spell_item_paladin_t16_4p") { }

	class spell_item_paladin_t16_4p_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_item_paladin_t16_4p_SpellScript);

		void HandleOnHit()
		{
			if (Player* _player = GetCaster()->ToPlayer())
				if (Unit* target = GetHitUnit())
					if (_player->HasAura(RETPALA_T16_AURA_4P))
						if (roll_chance_i(25))
						{
							_player->CastSpell(target, RETPALA_T16_SPELL_4P, true);
						}
		...
		void Register()
		{
			OnHit += SpellHitFn(spell_item_paladin_t16_4p_SpellScript::HandleOnHit);
		}
	};

	SpellScript* GetSpellScript() const
	{
		return new spell_item_paladin_t16_4p_SpellScript();
	}
};

class spell_novo_avenging1 : public SpellScriptLoader
{
public:
	spell_novo_avenging1() : SpellScriptLoader("spell_novo_avenging1") { }

	class spell_novo_avenging1_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_novo_avenging1_SpellScript);
		...
		void HandleOnCast()
		{
			if (Unit* caster = GetCaster())
				...
				if (caster->HasAura(21359))
					...
					caster->CastSpell(caster, 124006, true);
		...
		void Register()
		{
			OnCast += SpellCastFn(spell_novo_avenging1_SpellScript::HandleOnCast);
		}
	};

	SpellScript* GetSpellScript() const
	{
		return new spell_novo_avenging1_SpellScript();
	}
};

class spell_novo_avenging2 : public SpellScriptLoader
{
public:
	spell_novo_avenging2() : SpellScriptLoader("spell_novo_avenging2") { }

	class spell_novo_avenging2_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_novo_avenging2_SpellScript);
		...
		void HandleOnCast()
		{
			if (Unit* caster = GetCaster())
				...
				if (caster->HasAura(21359))
					...
					caster->CastSpell(caster, 99634, true);
		...
		void Register()
		{
			OnCast += SpellCastFn(spell_novo_avenging2_SpellScript::HandleOnCast);
		}
	};

	SpellScript* GetSpellScript() const
	{
		return new spell_novo_avenging2_SpellScript();
	}
};

class spell_novo_avenging3 : public SpellScriptLoader
{
public:
	spell_novo_avenging3() : SpellScriptLoader("spell_novo_avenging3") { }

	class spell_novo_avenging3_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_novo_avenging3_SpellScript);
		...
		void HandleOnCast()
		{
			if (Unit* caster = GetCaster())
				...
				if (caster->HasAura(21359))
					...
					caster->CastSpell(caster, 70571, true);
		...
		void Register()
		{
			OnCast += SpellCastFn(spell_novo_avenging3_SpellScript::HandleOnCast);
		}
	};

	SpellScript* GetSpellScript() const
	{
		return new spell_novo_avenging3_SpellScript();
	}
};


class spell_sealofturth_fix : public SpellScriptLoader
{
public:
	spell_sealofturth_fix() : SpellScriptLoader("spell_sealofturth_fix") { }

	class spell_sealofturth_fix_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_sealofturth_fix_SpellScript);

		void HandleOnHit()
		{
			if (Player* _player = GetCaster()->ToPlayer())
				if (Unit* target = GetHitUnit())
					if (_player->HasAura(RETPALA_SEALOFTRUTH_AURA))
						if (roll_chance_i(100))
						{
							_player->CastSpell(target, RETPALA_SEALOFTRUTH_SPELL, true);
						}
		...
		void Register()
		{
			OnHit += SpellHitFn(spell_sealofturth_fix_SpellScript::HandleOnHit);
		}
	};

	SpellScript* GetSpellScript() const
	{
		return new spell_sealofturth_fix_SpellScript();
	}
};
void AddSC_paladin_spell_scripts()
{
	new spell_sealofturth_fix();
	new spell_novo_avenging1();
	new spell_novo_avenging2();
	new spell_novo_avenging3();
	new spell_item_paladin_t16_4p();
