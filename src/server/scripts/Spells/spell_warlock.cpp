            ...
            void OnTick(AuraEffect const* aurEff)
            {
                if (Unit* caster = GetCaster())
                {
                    ...
                    if (_player->GetSpecializationId(_player->GetActiveSpec()) == SPEC_WARLOCK_DEMONOLOGY)
                        _player->EnergizeBySpell(_player, 689, 15, POWER_DEMONIC_FURY);
        ...
        class spell_warl_molten_core_dot_AuraScript : public AuraScript
        {
            ...
            void OnTick(AuraEffect const* aurEff)
            {
                if (GetCaster())
                {
                    ...
                    GetCaster()->EnergizeBySpell(GetCaster(), aurEff->GetSpellInfo()->Id, 5, POWER_DEMONIC_FURY);
                }
            }
    ...
    public:
        ...
        class spell_warl_hellfire_SpellScript : public SpellScript
        {
            ...
            void HandleOnHit()
            {
                if (Player* _player = GetCaster()->ToPlayer())
                    if (Unit* target = GetHitUnit())
                        _player->EnergizeBySpell(_player, GetSpellInfo()->Id, 5, POWER_DEMONIC_FURY);
            }
    ...
    public:
        ...
        class spell_warl_nightfall_AuraScript : public AuraScript
        {
            ...
            void OnTick(AuraEffect const* aurEff)
            {
                ...
                {
                    if (_player->GetSpecializationId(_player->GetActiveSpec()) == SPEC_WARLOCK_DEMONOLOGY)
                        _player->EnergizeBySpell(_player, GetSpellInfo()->Id, 8, POWER_DEMONIC_FURY);
                }
            }
...
class spell_visual_circulo : public SpellScriptLoader
{
public:
	spell_visual_circulo() : SpellScriptLoader("spell_visual_circulo") { }

	class spell_visual_circulo_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_visual_circulo_SpellScript);
		...
		void HandleOnCast()
		{
			if (Unit* caster = GetCaster())
				...
				if (caster->HasAura(21359))
					...
					caster->CastSpell(caster, 140704, true);
		...
		void Register()
		{
			OnCast += SpellCastFn(spell_visual_circulo_SpellScript::HandleOnCast);
		}
	};

	SpellScript* GetSpellScript() const
	{
		return new spell_visual_circulo_SpellScript();
	}
};


class spell_visual_estouro : public SpellScriptLoader
{
public:
	spell_visual_estouro() : SpellScriptLoader("spell_visual_estouro") { }

	class spell_visual_estouro_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_visual_estouro_SpellScript);
		...
		void HandleOnCast()
		{
			if (Unit* caster = GetCaster())
				...
				if (caster->HasAura(21359))
					...
					caster->CastSpell(caster, 74883, true);
		...
		void Register()
		{
			OnCast += SpellCastFn(spell_visual_estouro_SpellScript::HandleOnCast);
		}
	};

	SpellScript* GetSpellScript() const
	{
		return new spell_visual_estouro_SpellScript();
	}
};


class spell_visual_vortex : public SpellScriptLoader
{
public:
	spell_visual_vortex() : SpellScriptLoader("spell_visual_vortex") { }

	class spell_visual_vortex_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_visual_vortex_SpellScript);
		...
		void HandleOnCast()
		{
			if (Unit* caster = GetCaster())
				...
				if (caster->HasAura(21359))
					...
					caster->CastSpell(caster, 114349, true);
		...
		void Register()
		{
			OnCast += SpellCastFn(spell_visual_vortex_SpellScript::HandleOnCast);
		}
	};

	SpellScript* GetSpellScript() const
	{
		return new spell_visual_vortex_SpellScript();
	}
};


class spell_visual_sombralock : public SpellScriptLoader
{
public:
	spell_visual_sombralock() : SpellScriptLoader("spell_visual_sombralock") { }

	class spell_visual_sombralock_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_visual_sombralock_SpellScript);
		...
		void HandleOnCast()
		{
			if (Unit* caster = GetCaster())
				...
				if (caster->HasAura(21359))
					...
					caster->CastSpell(caster, 83970, true);
		...
		void Register()
		{
			OnCast += SpellCastFn(spell_visual_sombralock_SpellScript::HandleOnCast);
		}
	};

	SpellScript* GetSpellScript() const
	{
		return new spell_visual_sombralock_SpellScript();
	}
};
...
void AddSC_warlock_spell_scripts()
{
	...
	new spell_visual_vortex();
	new spell_visual_estouro();
	new spell_visual_circulo();
	new spell_visual_sombralock();
