...
enum PriestSpells
{
	...
	PRIEST_T162PDISC_AURA							= 145306,
	PRIEST_T162PDISC_SPELL							= 145330
                        ...
                        if (_player->HasAura(PRIEST_TRAIN_OF_THOUGHT))
                        {
                            if (GetSpellInfo()->Id == 585)
                            {
                                if (_player->HasSpellCooldown(PRIEST_SPELL_PENANCE))
                                    _player->ReduceSpellCooldown(PRIEST_SPELL_PENANCE, -2000);
                            }
                            else if (GetSpellInfo()->Id == 2060)
                            {
                                if (_player->HasSpellCooldown(PRIEST_INNER_FOCUS))
                                    _player->ReduceSpellCooldown(PRIEST_SPELL_PENANCE, -25000);
                            }
                        }
                    }
                }
                    ...
                    if (Unit* target = GetHitUnit())
                    {
                        switch (GetSpellInfo()->Id)
                        {
                            case 124464:
                                ...
                                if (caster->HasAura(PRIEST_SPELL_DIVINE_INSIGHT_TALENT) && roll_chance_i(25))
                                {
...
class spell_item_priest_t16_disciple_2p : public SpellScriptLoader
{
public:
	spell_item_priest_t16_disciple_2p() : SpellScriptLoader("spell_item_priest_t16_disciple_2p") { }

	class spell_item_priest_t16_disciple_2p_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_item_priest_t16_disciple_2p_SpellScript);

		void HandleOnHit()
		{
			if (Player* _player = GetCaster()->ToPlayer())
				if (Unit* target = GetHitUnit())
					if (_player->HasAura(PRIEST_T162PDISC_AURA))
						_player->CastSpell(target, PRIEST_T162PDISC_SPELL, true);
		}

		void Register()
		{
			OnHit += SpellHitFn(spell_item_priest_t16_disciple_2p_SpellScript::HandleOnHit);
		}
	};

	SpellScript* GetSpellScript() const
	{
		return new spell_item_priest_t16_disciple_2p_SpellScript();
	}
};


class spell_novo_tentaculo1 : public SpellScriptLoader
{
public:
	spell_novo_tentaculo1() : SpellScriptLoader("spell_novo_tentaculo1") { }

	class spell_novo_tentaculo1_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_novo_tentaculo1_SpellScript);
		...
		void HandleOnCast()
		{
			if (Unit* caster = GetCaster())
				...
				if (caster->HasAura(21359))
					...
					caster->CastSpell(caster, 92719, true);
		...
		void Register()
		{
			OnCast += SpellCastFn(spell_novo_tentaculo1_SpellScript::HandleOnCast);
		}
	};

	SpellScript* GetSpellScript() const
	{
		return new spell_novo_tentaculo1_SpellScript();
	}
};

class spell_novo_tentaculo2 : public SpellScriptLoader
{
public:
	spell_novo_tentaculo2() : SpellScriptLoader("spell_novo_tentaculo2") { }

	class spell_novo_tentaculo2_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_novo_tentaculo2_SpellScript);
		...
		void HandleOnCast()
		{
			if (Unit* caster = GetCaster())
				...
				if (caster->HasAura(21359))
					...
					caster->CastSpell(caster, 92718, true);
		...
		void Register()
		{
			OnCast += SpellCastFn(spell_novo_tentaculo2_SpellScript::HandleOnCast);
		}
	};

	SpellScript* GetSpellScript() const
	{
		return new spell_novo_tentaculo2_SpellScript();
	}
};

class spell_novo_sombraube : public SpellScriptLoader
{
public:
	spell_novo_sombraube() : SpellScriptLoader("spell_novo_sombraube") { }

	class spell_novo_sombraube_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_novo_sombraube_SpellScript);
		...
		void HandleOnCast()
		{
			if (Unit* caster = GetCaster())
				...
				if (caster->HasAura(21359))
					...
					caster->CastSpell(caster, 73305, true);
		...
		void Register()
		{
			OnCast += SpellCastFn(spell_novo_sombraube_SpellScript::HandleOnCast);
		}
	};

	SpellScript* GetSpellScript() const
	{
		return new spell_novo_sombraube_SpellScript();
	}
};

class spell_priest_disc_damagered : public SpellAreaTriggerScript
{
public:
	spell_priest_disc_damagered() : SpellAreaTriggerScript("spell_priest_disc_damagered") {}
...
class spell_priest_t16holy_2p : public SpellScriptLoader
{
public:
	spell_priest_t16holy_2p() : SpellScriptLoader("spell_priest_t16holy_2p") { }

	class spell_priest_t16holy_2p_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_priest_t16holy_2p_SpellScript);

		void HandleOnCast()
		{
			if (Unit* caster = GetCaster())

				if (caster->HasAura(145306))


					caster->CastSpell(caster, 145327, true);
		...
		void Register()
		{
			OnCast += SpellCastFn(spell_priest_t16holy_2p_SpellScript::HandleOnCast);
		}
	};

	SpellScript* GetSpellScript() const
	{
		return new spell_priest_t16holy_2p_SpellScript();
	}
};

class spell_priest_t16holy_4p : public SpellScriptLoader
{
public:
	spell_priest_t16holy_4p() : SpellScriptLoader("spell_priest_t16holy_4p") { }

	class spell_priest_t16holy_4p_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_priest_t16holy_4p_SpellScript);
		...
		void HandleOnCast()
		{
			if (Unit* caster = GetCaster())
				...
				if (caster->HasAura(145334))
					if (caster->HasAura(95649))

					caster->CastSpell(caster, 145336, true);
		...
		void Register()
		{
			OnCast += SpellCastFn(spell_priest_t16holy_4p_SpellScript::HandleOnCast);
		}
	};

	SpellScript* GetSpellScript() const
	{
		return new spell_priest_t16holy_4p_SpellScript();
	}
};

class spell_priest_t16disc_4p : public SpellScriptLoader
{
public:
	spell_priest_t16disc_4p() : SpellScriptLoader("spell_priest_t16disc_4p") { }

	class spell_priest_t16disc_4p_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_priest_t16disc_4p_SpellScript);
		...
		void HandleOnCast()
		{
			if (Unit* caster = GetCaster())
				...
				if (caster->HasAura(145334))
						...
						caster->CastSpell(caster, 145374, true);
		...
		void Register()
		{
			OnCast += SpellCastFn(spell_priest_t16disc_4p_SpellScript::HandleOnCast);
		}
	};

	SpellScript* GetSpellScript() const
	{
		return new spell_priest_t16disc_4p_SpellScript();
	}
};
...
{
	new spell_priest_t16disc_4p();
	new spell_priest_t16holy_4p();
	new spell_priest_t16holy_2p();
	new spell_novo_sombraube();
	new spell_priest_disc_damagered();
	new spell_novo_tentaculo1();
	new spell_novo_tentaculo2();
	...
	new spell_item_priest_t16_disciple_2p();
}
